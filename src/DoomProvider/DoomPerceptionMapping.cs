...
/// JA: Doom 固有 game state を generic HUD signal DTO に写像します。
/// </summary>
public sealed class DoomHudSignalMapper
{
    ...
    /// JA: CTG / Gate decision を行わず Doom game state を HUD signal に変換します。
    /// </summary>
...
/// JA: Doom 固有 perception metadata を overlay annotation DTO に写像します。
/// </summary>
public sealed class DoomOverlayAnnotationMapper
{
    ...
    /// JA: rendering を行わず Doom sensor fusion snapshot を overlay annotation に変換します。
    /// </summary>
...
/// JA: Doom autoplay action command を generic virtual input DTO に写像します。
/// </summary>
public sealed class DoomInputMappingAdapter
{
    /// <summary>
    /// EN: Converts a Doom action command into a virtual keyboard input state request.
    /// JA: Doom action command を virtual keyboard input state request に変換します。
    /// </summary>
