...
public sealed class DoomWebAssetCacheTests
{
    ...
    public void DoomWorker_UsesVersionedRuntimeAssetsToAvoidBrowserCache()
    {
        ...
        Assert.Contains("doom-worker.js?v=${encodeURIComponent(cacheKey)}", proxy, StringComparison.Ordinal);
        Assert.Contains("return `${workerScriptBase}${relativePath}?v=${encodeURIComponent(workerCacheKey)}`;", worker, StringComparison.Ordinal);
        Assert.Contains("scriptUrl(\"/js/autoplay-profile.js\")", worker, StringComparison.Ordinal);
        Assert.Contains("scriptUrl(\"/js/autoplay/gpu-contracts.js\")", worker, StringComparison.Ordinal);
        Assert.Contains("scriptUrl(\"/js/webgpu-provider.js\")", worker, StringComparison.Ordinal);
        Assert.Contains("scriptUrl(\"/js/autoplay/cognition/semantics.js\")", worker, StringComparison.Ordinal);
        Assert.Contains("scriptUrl(\"/js/autoplay/cognition/routing.js\")", worker, StringComparison.Ordinal);
        Assert.Contains("scriptUrl(\"/js/autoplay/cognition/topos.js\")", worker, StringComparison.Ordinal);
        Assert.Contains("scriptUrl(\"/js/autoplay/cognition/ctg.js\")", worker, StringComparison.Ordinal);
        Assert.Contains("scriptUrl(\"/js/autoplay/cognition/sensory.js\")", worker, StringComparison.Ordinal);
        Assert.Contains("scriptUrl(\"/js/autoplay/cognition/vision-palette.js\")", worker, StringComparison.Ordinal);
        Assert.Contains("scriptUrl(\"/js/autoplay/cognition/phainesis.js\")", worker, StringComparison.Ordinal);
        Assert.Contains("scriptUrl(\"/js/autoplay/cognition/nous.js\")", worker, StringComparison.Ordinal);
        Assert.Contains("scriptUrl(\"/js/autoplay/cognition/phantasia.js\")", worker, StringComparison.Ordinal);
        Assert.Contains("scriptUrl(\"/js/autoplay/cognition/kairos.js\")", worker, StringComparison.Ordinal);
        Assert.Contains("scriptUrl(\"/js/autoplay/cognition/kinesis.js\")", worker, StringComparison.Ordinal);
        Assert.Contains("scriptUrl(\"/js/autoplay/cognition/zoe.js\")", worker, StringComparison.Ordinal);
        Assert.Contains("scriptUrl(\"/js/autoplay/cognition/pipeline-trace.js\")", worker, StringComparison.Ordinal);
        Assert.Contains("scriptUrl(\"/js/autoplay/sensor-tensor.js\")", worker, StringComparison.Ordinal);
        ...
        Assert.Contains("scriptUrl(\"/js/autoplay/wasm-state.js\")", worker, StringComparison.Ordinal);
        ...
        Assert.Contains("scriptUrl(\"/js/bonsai.js\")", worker, StringComparison.Ordinal);
        Assert.Contains("scriptUrl(\"/js/doom-debug-audio.js\")", worker, StringComparison.Ordinal);
        Assert.Contains("scriptUrl(\"/js/doom.js\")", worker, StringComparison.Ordinal);
        Assert.Contains("webgpu-provider.js?v=${encodeURIComponent(SCRIPT_CACHE_KEY)}", runtime, StringComparison.Ordinal);
